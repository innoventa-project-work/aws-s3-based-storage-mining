        ...
        <div class="panel-body">
          <div class="table-responsive">
			...
			<tr>
				<td>${i.id}</td>
				<td>${i.bucketName}</td>
				<td>${i.regionVO.regionName}</td>
				
				<td><div class="btn-group mb-sm"><button class="btn btn-inverse dropdown-toggle" data-toggle="dropdown" type="button" name="${i.id}">Action<span class="caret"></span></button>
				<ul class="dropdown-menu" role="menu"><li><a href="<%=request.getContextPath()%>/bucketController?flag=Editbucket&bucketId=${i.id}">Edit</a></li>
				<li><a href="<%=request.getContextPath()%>/bucketController?flag=Deletebucket&bucketId=${i.id}">DELETE</a></li></ul></div></td>
				
			</tr>
			
			<c:remove var="bucketList" scope="session" />
		</c:forEach>
              </tbody>
