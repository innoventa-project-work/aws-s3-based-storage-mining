        ...
        <div class="panel-body">
          <div class="table-responsive">
			...
			<tr>
				...
				<td><div class="btn-group mb-sm"><button class="btn btn-inverse dropdown-toggle" data-toggle="dropdown" type="button" name="${i.loginid}">Action<span class="caret"></span></button>
				<ul class="dropdown-menu" role="menu"><li><a href="<%=request.getContextPath()%>/loginController?flag=Editlogin&loginid=${i.loginid}">Edit</a></li>
				<li><a href="<%=request.getContextPath()%>/loginController?flag=Deleterlogin&loginid=${i.loginid}">DELETE</a></li></ul></div></td>
				
			</tr>
			
			<c:remove var="loginList" scope="session" />
		</c:forEach>
              </tbody>
                  </table>
          </div>
