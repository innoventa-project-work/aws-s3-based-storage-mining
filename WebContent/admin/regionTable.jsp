    ...
    <div class="contentpanel">
      ...
      <div class="panel">
        <div class="panel-heading">
          <h4 class="panel-title">View Region</h4>
        ...
        <div class="panel-body">
          <div class="table-responsive">
			...
			<tr>
				<td>${i.regionId}</td>
				<td>${i.regionName}</td>
				<td>${i.regionDescription}</td>
				<td>
				<div class="btn-group mb-sm"><button class="btn btn-inverse dropdown-toggle" data-toggle="dropdown" type="button" name="${i.regionId}">Action<span class="caret"></span></button>
				<ul class="dropdown-menu" role="menu">
				<li><a href="<%=request.getContextPath()%>/regionController?flag=editRegion&regionId=${i.regionId}">EDIT</a></li>
			...
			<c:remove var="regionList" scope="session" />
		</c:forEach>
